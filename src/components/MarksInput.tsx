...
import { Plus, Trash2, FileText, File, Clipboard } from "lucide-react";
  ...
  return (
    <div className="flex flex-col h-screen bg-background max-w-md mx-auto overflow-hidden">
      ...
      <div className="pt-20 px-6 pb-3 flex-shrink-0">
        ...
        <p className="text-sm text-muted-foreground font-semibold mb-3">Leave empty if not taken yet</p>
      ...
      <div className="flex-1 overflow-y-auto px-6 pb-4">
        ...
        {!showAddSubject ? (
          <button
            ...
            className="w-full flex items-center justify-center gap-2 rounded-xl border-2 border-dashed border-primary/40 py-3 text-sm font-bold text-primary active:scale-[0.98] transition-transform mb-4"
          >
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div className="flex items-center gap-2">
                    {avg !== null && (
                      <span className="text-sm font-bold text-primary">Avg: {avg.toFixed(1)}</span>
                    )}
                    <button onClick={() => removeSubject(sub.id)} className="text-destructive/50 hover:text-destructive transition-colors">
